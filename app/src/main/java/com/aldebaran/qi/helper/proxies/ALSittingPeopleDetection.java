...
public class ALSittingPeopleDetection extends ALProxy {
    ...
    */
    public void setSittingThreshold(Float threshold) throws DynamicCallException, ExecutionException{
    ...
    */
    public Float getSittingThreshold() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> setSittingThreshold(Float threshold) throws DynamicCallException, ExecutionException{
    ...
    * @return Maximum face height in meter
    */
    public Future<Float> getSittingThreshold() throws DynamicCallException, ExecutionException {
