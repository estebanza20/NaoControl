...
public class ALVisualSpaceHistory extends ALProxy {
    ...
    */
    public Float getGridPrecision() throws DynamicCallException, ExecutionException {
    ...
    * 
    */
    public void resetGrid() throws DynamicCallException, ExecutionException{
        call("resetGrid").get();
    }
    ...
    */
    public void setGridPrecision(Float precision) throws DynamicCallException, ExecutionException{
    ...
    * @return Grid precision
    */
    public Future<Float> getGridPrecision() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> resetGrid() throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> setGridPrecision(Float precision) throws DynamicCallException, ExecutionException{
