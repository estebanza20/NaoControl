...
public class ALFaceCharacteristics extends ALProxy {
    ...
    */
    public Float getSmilingThreshold() throws DynamicCallException, ExecutionException {
    ...
    */
    public Boolean analyzeFaceCharacteristics(Integer id) throws DynamicCallException, ExecutionException {
    ...
    */
    public void setSmilingThreshold(Float threshold) throws DynamicCallException, ExecutionException{
    ...
    * @return Threshold for Smiling event
    */
    public Future<Float> getSmilingThreshold() throws DynamicCallException, ExecutionException {
    ...
    * @return True if the face analysis succeeded, false otherwise.
    */
    public Future<Boolean> analyzeFaceCharacteristics(Integer id) throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> setSmilingThreshold(Float threshold) throws DynamicCallException, ExecutionException{
