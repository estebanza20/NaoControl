...
public class ALVideoRecorder extends ALProxy {
    ...
    */
    public String getVideoFormat() throws DynamicCallException, ExecutionException {
    ...
    */
    public void startRecording(String folderPath, String fileName) throws DynamicCallException, ExecutionException{
    ...
    */
    public void startRecording(String folderPath, String fileName, Boolean overwrite) throws DynamicCallException, ExecutionException{
    ...
    */
    public Object stopRecording() throws DynamicCallException, ExecutionException {
    ...
    * @return True/False
    */
    public Boolean isRecording() throws DynamicCallException, ExecutionException {
    ...
    */
    public void setFrameRate(Float frameRate) throws DynamicCallException, ExecutionException{
    ...
    */
    public void setVideoFormat(String videoFormat) throws DynamicCallException, ExecutionException{
    ...
    * @return Current video format.
    */
    public Future<String> getVideoFormat() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> startRecording(String folderPath, String fileName) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> startRecording(String folderPath, String fileName, Boolean overwrite) throws DynamicCallException, ExecutionException{
    ...
    * @return Array of two elements [numRecordedFrames, recordAbsolutePath]
    */
    public Future<Object> stopRecording() throws DynamicCallException, ExecutionException {
    ...
    * @return True/False
    */
    public Future<Boolean> isRecording() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> setFrameRate(Float frameRate) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> setVideoFormat(String videoFormat) throws DynamicCallException, ExecutionException{
