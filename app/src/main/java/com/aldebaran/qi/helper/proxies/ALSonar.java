...
public class ALSonar extends ALProxy {
    ...
    * 
    */
    public List<Float> getFilteredValues() throws DynamicCallException, ExecutionException {
    ...
    * 
    */
    public Future<List<Float>> getFilteredValues() throws DynamicCallException, ExecutionException {
