...
public class ALNotificationManager extends ALProxy {
    ...
    */
    public Integer add(Object notification) throws DynamicCallException, ExecutionException {
    ...
    */
    public void remove(Integer notificationId) throws DynamicCallException, ExecutionException{
    ...
    */
    public Object notifications() throws DynamicCallException, ExecutionException {
    ...
    */
    public Object notification(Integer notificationId) throws DynamicCallException, ExecutionException {
    ...
    * @return Notification ID.
    */
    public Future<Integer> add(Object notification) throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> remove(Integer notificationId) throws DynamicCallException, ExecutionException{
    ...
    * @return An array of pending notification.
    */
    public Future<Object> notifications() throws DynamicCallException, ExecutionException {
    ...
    * @return ALValue containing a Notification.
    */
    public Future<Object> notification(Integer notificationId) throws DynamicCallException, ExecutionException {
