...
public class ALMotionRecorder extends ALProxy {
    ...
    */
    public void startInteractiveRecording(List<String> jointsToRecord, Integer nbPoses, Boolean extensionAllowed, Integer mode) throws DynamicCallException, ExecutionException{
    ...
    */
    public void startPeriodicRecording(List<String> jointsToRecord, Integer nbPoses, Boolean extensionAllowed, Float timeStep, List<String> jointsToReplay, Object replayData) throws DynamicCallException, ExecutionException{
    ...
    */
    public Object stopAndGetRecording() throws DynamicCallException, ExecutionException {
    ...
    */
    public void dataChanged(String dataName, Object data, String message) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> startInteractiveRecording(List<String> jointsToRecord, Integer nbPoses, Boolean extensionAllowed, Integer mode) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> startPeriodicRecording(List<String> jointsToRecord, Integer nbPoses, Boolean extensionAllowed, Float timeStep, List<String> jointsToReplay, Object replayData) throws DynamicCallException, ExecutionException{
    ...
    * @return Returns the recorded data as an ALValue: [[JointName1,[pos1, pos2, ...]], [JointName2,[pos1, pos2, ...]], ...]
    */
    public Future<Object> stopAndGetRecording() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> dataChanged(String dataName, Object data, String message) throws DynamicCallException, ExecutionException{
