...
public class ALWavingDetection extends ALProxy {
    ...
    */
    public void setMinSize(Float sensitivity) throws DynamicCallException, ExecutionException {
    ...
    */
    public void setMaxDistance(Float maxDistance) throws DynamicCallException, ExecutionException{
    ...
    */
    public Float getMaxDistance() throws DynamicCallException, ExecutionException {
    ...
    */
    public Float getMinSize() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> setMinSize(Float sensitivity) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> setMaxDistance(Float maxDistance) throws DynamicCallException, ExecutionException{
    ...
    * @return Current maximum distance (in meters)
    */
    public Future<Float> getMaxDistance() throws DynamicCallException, ExecutionException {
    ...
    * @return Current minimum size (in meters)
    */
    public Future<Float> getMinSize() throws DynamicCallException, ExecutionException {
