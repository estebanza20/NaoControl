...
public class ALLaser extends ALProxy {
    ...
    * 
    */
    public void laserOFF() throws DynamicCallException, ExecutionException{
        call("laserOFF").get();
    }
    ...
    * 
    */
    public void laserON() throws DynamicCallException, ExecutionException{
        call("laserON").get();
    }
    ...
    */
    public void setOpeningAngle(Float angle_min_f, Float angle_max_f) throws DynamicCallException, ExecutionException{
    ...
    */
    public void setDetectingLength(Integer length_min_l, Integer length_max_l) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> laserOFF() throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> laserON() throws DynamicCallException, ExecutionException{
        return call("laserON");
    }
    ...
    * @return The Future
    */
    public Future<Void> setOpeningAngle(Float angle_min_f, Float angle_max_f) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> setDetectingLength(Integer length_min_l, Integer length_max_l) throws DynamicCallException, ExecutionException{
