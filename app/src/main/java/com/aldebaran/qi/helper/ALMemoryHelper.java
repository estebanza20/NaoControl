...
public abstract class ALMemoryHelper extends ALProxy{
	 ...
	 * */
	public AnyObject subscriber(String eventName) throws DynamicCallException, ExecutionException {
		if (service == null)
	 ...
	 * */
	public void unsubscribeToEvent(long eventID) throws ExecutionException, DynamicCallException {
	 ...
	 * */
	public void unsubscribeAllEvents() throws ExecutionException, DynamicCallException {
