...
public class ALDarknessDetection extends ALProxy {
    ...
    */
    public void setDarknessThreshold(Integer threshold) throws DynamicCallException, ExecutionException{
    ...
    */
    public Integer getDarknessThreshold() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> setDarknessThreshold(Integer threshold) throws DynamicCallException, ExecutionException{
    ...
    * @return Current darkness threshold value
    */
    public Future<Integer> getDarknessThreshold() throws DynamicCallException, ExecutionException {
