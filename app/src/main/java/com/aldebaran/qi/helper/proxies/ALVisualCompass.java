...
public class ALVisualCompass extends ALProxy {
    ...
    */
    public Object getReferenceImage() throws DynamicCallException, ExecutionException {
    ...
    */
    public void enableReferenceRefresh(Boolean refresh) throws DynamicCallException, ExecutionException{
    ...
    */
    public Boolean setCurrentImageAsReference() throws DynamicCallException, ExecutionException {
    ...
    */
    public Boolean moveTo(Float x, Float y, Float theta) throws DynamicCallException, ExecutionException {
    ...
    */
    public Boolean moveStraightTo(Float x) throws DynamicCallException, ExecutionException {
    ...
    * 
    */
    public void waitUntilTargetReached() throws DynamicCallException, ExecutionException{
 ...
 [1]: Number of keypoints matching.
    */
    public Object getMatchingQuality() throws DynamicCallException, ExecutionException {
    ...
    * @return Reference image (formatted as the ALValue from getImageRemote of ALVideoDevice)
    */
    public Future<Object> getReferenceImage() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> enableReferenceRefresh(Boolean refresh) throws DynamicCallException, ExecutionException{
    ...
    * @return True if the reference image has been successfully set
    */
    public Future<Boolean> setCurrentImageAsReference() throws DynamicCallException, ExecutionException {
    ...
    * @param theta  Rotation around the Z axis in radians [-3.1415 to 3.1415].
    */
    public Future<Boolean> moveTo(Float x, Float y, Float theta) throws DynamicCallException, ExecutionException {
    ...
    * @param x  Algebric distance along the X axis in meters.
    */
    public Future<Boolean> moveStraightTo(Float x) throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> waitUntilTargetReached() throws DynamicCallException, ExecutionException{
 ...
 [1]: Number of keypoints matching.
    */
    public Future<Object> getMatchingQuality() throws DynamicCallException, ExecutionException {
