...
public class ALMovementDetection extends ALProxy {
    ...
    */
    public void setColorSensitivity(Float sensitivity) throws DynamicCallException, ExecutionException{
    ...
    */
    public void setDepthSensitivity(Float sensitivity) throws DynamicCallException, ExecutionException{
    ...
    */
    public Float getDepthSensitivity() throws DynamicCallException, ExecutionException {
    ...
    * 
    */
    public void resetDetection() throws DynamicCallException, ExecutionException{
    ...
    */
    public Float getColorSensitivity() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> setColorSensitivity(Float sensitivity) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> setDepthSensitivity(Float sensitivity) throws DynamicCallException, ExecutionException{
    ...
    * @return Current depth sensitivity (in meters)
    */
    public Future<Float> getDepthSensitivity() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> resetDetection() throws DynamicCallException, ExecutionException{
    ...
    * @return Current color sensitivity (between 0 and 1)
    */
    public Future<Float> getColorSensitivity() throws DynamicCallException, ExecutionException {
