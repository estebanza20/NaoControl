...
public class ALSegmentation3D extends ALProxy {
    ...
    */
    public void setBlobTrackingEnabled(Boolean status) throws DynamicCallException, ExecutionException{
    ...
    */
    public void setBlobTrackingDistance(Float distance) throws DynamicCallException, ExecutionException{
    ...
    * 
    */
    public Float getBlobTrackingDistance() throws DynamicCallException, ExecutionException {
    ...
    * @return True if the update succeeded, False if not
    */
    public Boolean setFrameRate(Integer value) throws DynamicCallException, ExecutionException {
    ...
    */
    public Float getVerticalOffset() throws DynamicCallException, ExecutionException {
    ...
    */
    public void setDeltaDepthThreshold(Float value) throws DynamicCallException, ExecutionException{
    ...
    */
    public Float getDeltaDepthThreshold() throws DynamicCallException, ExecutionException {
    ...
    */
    public Object getTopOfBlob(Float distance, Integer frame, Boolean applyVerticalOffset) throws DynamicCallException, ExecutionException {
    ...
    */
    public Boolean isBlobTrackingEnabled() throws DynamicCallException, ExecutionException {
    ...
    */
    public void setVerticalOffset(Float value) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> setBlobTrackingEnabled(Boolean status) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> setBlobTrackingDistance(Float distance) throws DynamicCallException, ExecutionException{
    ...
    * 
    */
    public Future<Float> getBlobTrackingDistance() throws DynamicCallException, ExecutionException {
    ...
    * @return True if the update succeeded, False if not
    */
    public Future<Boolean> setFrameRate(Integer value) throws DynamicCallException, ExecutionException {
    ...
    * @return Current vertical offset of the blob tracker
    */
    public Future<Float> getVerticalOffset() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> setDeltaDepthThreshold(Float value) throws DynamicCallException, ExecutionException{
    ...
    * @return Current depth threshold (in meters)
    */
    public Future<Float> getDeltaDepthThreshold() throws DynamicCallException, ExecutionException {
    ...
    * @return Position of the top of the corresponding blob (if one is found) in the given frame (Format: [yaw,pitch,distance] in FRAME_IMAGE, [x,y,z] in the other frame).
    */
    public Future<Object> getTopOfBlob(Float distance, Integer frame, Boolean applyVerticalOffset) throws DynamicCallException, ExecutionException {
    ...
    * @return True if the blob tracker is enabled, False otherwise.
    */
    public Future<Boolean> isBlobTrackingEnabled() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> setVerticalOffset(Float value) throws DynamicCallException, ExecutionException{
