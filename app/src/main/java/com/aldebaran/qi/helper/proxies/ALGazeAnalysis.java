...
public class ALGazeAnalysis extends ALProxy {
    ...
    */
    public void setTolerance(Float tolerance) throws DynamicCallException, ExecutionException {
    ...
    */
    public void setFaceAnalysisEnabled(Boolean status) throws DynamicCallException, ExecutionException{
    ...
    */
    public Boolean isFaceAnalysisEnabled() throws DynamicCallException, ExecutionException {
    ...
    */
    public Float getTolerance() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> setTolerance(Float tolerance) throws DynamicCallException, ExecutionException{
    ...
    * @return The Future
    */
    public Future<Void> setFaceAnalysisEnabled(Boolean status) throws DynamicCallException, ExecutionException{
    ...
    * @return True if face analysis is enabled, False otherwise.
    */
    public Future<Boolean> isFaceAnalysisEnabled() throws DynamicCallException, ExecutionException {
    ...
    * @return Current value of the tolerance.
    */
    public Future<Float> getTolerance() throws DynamicCallException, ExecutionException {
