...
public class ALBattery extends ALProxy {
    ...
    */
    public void enablePowerMonitoring(Boolean Enable) throws DynamicCallException, ExecutionException{
    ...
    */
    public Integer getBatteryCharge() throws DynamicCallException, ExecutionException {
    ...
    * @return The Future
    */
    public Future<Void> enablePowerMonitoring(Boolean Enable) throws DynamicCallException, ExecutionException{
    ...
    * @return the percentage of remaining power
    */
    public Future<Integer> getBatteryCharge() throws DynamicCallException, ExecutionException {
